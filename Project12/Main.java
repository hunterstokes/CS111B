...
class Main extends JFrame implements ActionListener {
  ...
  public void actionPerformed(ActionEvent event) {
    ...
    if (buttonPressed == this.lowerButton) {
      System.out.println("Lower button was pressed");
      try {
        this.guesser.lower();
    ...
    if (buttonPressed == this.higherButton) {
      System.out.println("Higher button was pressed");
      try {
        this.guesser.higher();
      } catch (NumberGuesserIllegalStateException e) {
        e.printStackTrace();
    ...
    if (buttonPressed == this.correctButton) {
      System.out.println("Correct button was pressed");
      System.exit(0);
    }
    ...
    if (buttonPressed == this.resetButton) {
      ...
      // You should remove this like from this reset block
